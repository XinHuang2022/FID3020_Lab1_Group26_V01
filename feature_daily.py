...
def generate_passenger(name, low_class, higher_class, age_min=0, age_max=160):
    """
...
def get_random_passenger():
    ...
    #                   })
    #
    # drowned_df = pd.DataFrame({"pclass": [random.randint(1,3)],
    #                    "age": [random.randint(age_min,age_max)/2],
    #                    "sibSp": [empirical_family_members('sibSp')],
    #                    "parch": [empirical_family_members('parch')],
    #                    "sex_male": [random.randint(0,1)]
    ...
    low_class = 1
    higher_class = 3
    survived_df = generate_passenger("survived", low_class, higher_class, age_min=0, age_max=160)
    drowned_df = generate_passenger("drowned", low_class, higher_class, age_min=0, age_max=160)
